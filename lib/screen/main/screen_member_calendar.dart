  ...
  //     List<TodayHistoryModel> matchedHistories = widget.historyList.where((historyModel) {
  ...
  //               child: ListBody(
  //                 children: matchedHistories.map((history) {
  //                   return Column(
  //                     crossAxisAlignment: CrossAxisAlignment.start,
  //                     children: [
  //                       Text('Attendance: ${history.attendance}'),
  //                       Text('Breakfast Image URIs: ${history.breakfastImageUri}'),
  //                       Text('Lunch Image URIs: ${history.lunchImageUri}'),
  //                       Text('Dinner Image URIs: ${history.dinnerImageUri}'),
  //                       Text('Today Image URIs: ${history.todayImageUri}'),
  //                       Text('Today Video URIs: ${history.todayVideoUri}'),
